...
def inputs_to_samples(inputs, tokenizer, max_length):
    ...
    for text in inputs:
        ...
        tokenized_lengths.append(len(tokens) - 2)
        tokenized_words.append(tokens[1:-1])
        ...
        all_att_mask.append(attention_mask)
        all_segment_ids.append(segment_ids)

    all_input_ids = torch.tensor(all_input_ids, dtype=torch.long)
    all_att_mask = torch.tensor(all_att_mask, dtype=torch.long)
